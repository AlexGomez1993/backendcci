...
const validarMail = async (req, res) => {
    ...
    <table style="width:100%; max-width:600px; margin:auto; font-family:Arial, sans-serif; border:1px solid #e0e0e0; border-collapse:collapse; box-shadow:0 2px 8px rgba(0,0,0,0.1);">
      <tr style="background-color:#d62228ff; color:white;">
        <td style="width:35%;padding:20px; text-align:left; vertical-align:middle;">
          <img src="cid:logo" alt="CCI Logo" style="height:50px; margin-right:10px;" />
        </td>
        <td style="width:65%;padding:10px; text-align:left; vertical-align:middle;">
      ...
      <tr>
        <td colspan="2" style="padding:20px;">
          ...
          <p style="font-size:24px; font-weight:bold; color:#d62228ff; text-align:center; margin:20px 0;">
            ${codigo}
          </p>
...
`;
        ...
        const mailOptions = {
            ...
            attachments: [
                {
                    filename: 'CCI.png',
                    path: path.join(__dirname, '../../public/CCI.png'),
                    cid: 'logo'
                }
            ]
        };
